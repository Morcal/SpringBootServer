...
public class RestExceptionAdvisor extends ResponseEntityExceptionHandler {
     ...
     *
     * @param principal servlet principal.
    ...
    public RestResponse handlePlatformException(Principal principal, HttpServletResponse response, PlatformException e) {
    ...
    public RestResponse handleSessionNotFoundException(Principal principal, SessionNotFoundException e) {
    ...
    public RestResponse handleRemoteException(Principal principal, HttpServletResponse response, RemoteException e) {
        setResponseStatus(response, e);
    ...
    public RestResponse handleServerException(Principal principal, HttpServletResponse response, ServerException e) {
        setResponseStatus(response, e);
    ...
    public RestResponse handleRuntimeException(Principal principal, RuntimeException e) {
        RestResponse rs = RestResponseBuilders.errorBuilder()
