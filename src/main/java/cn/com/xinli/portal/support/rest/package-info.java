 ...
 *
 * <p>PWS REST APIs need clients to provide {@link cn.com.xinli.portal.support.rest.Authentication}
 * and {@link cn.com.xinli.portal.support.rest.Authorization} before any REST operations.
 *
 * <p>Portal connections are encoded with JSON format of {@link cn.com.xinli.portal.support.rest.SessionBean}.
 * And PWS respond all portal connection related operations with
 * {@link cn.com.xinli.portal.support.rest.SessionResponse}s.
 *
 * <p>Any REST APIs related error will be represented with {@link cn.com.xinli.portal.support.rest.RestError}.
 */
