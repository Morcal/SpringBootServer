 ...
 * <p>
 * {@link AuthenticationException}s are generated by spring-security framework.
 * <p>
 * This class will return a HTTP 401 status with
...
public class RestAuthenticationEntryPoint implements AuthenticationEntryPoint {
     ...
     * <p>
     * This function will return a HTTP 401 status with
     ...
     * <p>
     * When token exception occurs, server should send an error to remote client
     * and indicates which token is invalid. For example, server send error message
     ...
     * <p>
     * Other authentication exceptions besides "token" exceptions do not need
